...
picker.on('change', (...args) => {
    ...
    let hexa_color = `#${Hex_r}${Hex_g}${Hex_b}`;
...
function hexToRGB(hex, alpha) {
    var r = parseInt(hex.slice(1, 3), 16),
        ...
        // change alpha value if provided 
    if (alpha) {
...
// html 5 color picker getting value 
document.getElementById("html5_color").addEventListener('change', (e) => {

    color = e.target.value;
    console.log(color);
    
    let html5_rgb_v = document.getElementById("html5_rgb");
    let html5_hex_v = document.getElementById("html5_hex");

    html5_hex_v.value = color;
    html5_rgb_v.value = hexToRGB(color);
